...
```bash
sam local invoke CreateUserFunction --docker-network lambda-local --event events/create_user_event.json --parameter-overrides Table=Users Region=us-east-1 AWSEnv=AWS_SAM_LOCAL
sam local invoke GetUserFunction --docker-network lambda-local --event events/get_user_event.json --parameter-overrides Table=Users Region=us-east-1 AWSEnv=AWS_SAM_LOCAL
sam local invoke ListUsersFunction --docker-network lambda-local --event events/list_users_event.json --parameter-overrides Table=Users Region=us-east-1 AWSEnv=AWS_SAM_LOCAL
sam local invoke UpdateUserFunction --docker-network lambda-local --event events/update_user_event.json --parameter-overrides Table=Users Region=us-east-1 AWSEnv=AWS_SAM_LOCAL
sam local invoke DeleteUserFunction --docker-network lambda-local --event events/delete_user_event.json --parameter-overrides Table=Users Region=us-east-1 AWSEnv=AWS_SAM_LOCAL
```
